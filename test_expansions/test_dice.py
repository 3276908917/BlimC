...
'''
Below this point: have test functions that I have added,
but which again do not check for accuracy.

The test immediately above also fails that criterion, but it was here when I got here.
'''
...
# I would like to test that the system exits properly in 
    # certain cases (e.g. no input file indicated)
# But sys.exit() blows up the testing environment, too...
